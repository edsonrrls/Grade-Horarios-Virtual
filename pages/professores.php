    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="professor">
                                ...
                                <?php while ($dado = $con->fetch_array()){ ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                        <center>
                                        <button type="button" class="btn btn-default btn-circle" data-toggle="modal" data-target="#info" data-whatevercod="<?php echo $dado["cod_prof"]; ?>" data-whatevernome="<?php echo $dado["nome_prof"]; ?>" data-whateverfone="<?php echo $dado["fone_prof"]; ?>" data-whateveremail="<?php echo $dado["email_prof"]; ?>">
                                                    <i class="fa fa-pencil"></i>
                                        </button>
                                        <button type="button" class="btn btn-default btn-circle" data-toggle="modal" data-target="#delete" data-whatevercod="<?php echo $dado["cod_prof"]; ?>" data-whatevernome="<?php echo $dado["nome_prof"]; ?>" data-whateverfone="<?php echo $dado["fone_prof"]; ?>" data-whateveremail="<?php echo $dado["email_prof"]; ?>">
            ...
            <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="myModalLabel">Remover - Professor:</h4>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="row">
                        <div class="col-lg-12">
                            <form role="form" method="POST" action="processa_exc_prof.php">

                            <input type="hidden" class="form-control" required="" name="cod" id="recipientcod">

                            <h4 class="modal-title" id="myModalLabel">Você realmente deseja remover o(a) professor(a)?</h4><p>
                                <div class="form-group">                                                                    
