                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="processa_cad_disciplina.php">
                                        <div class="form-group">
                                            <label>Nome:</label>
                                            <input class="form-control" required="" name="disc">
                                            <p class="help-block">Digite o nome da disciplina.</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" required="" name="curso">
                                                ...
                                                <option value="Biocombustíveis">Biocombustiveis</option>
                                                <option value="Análise e Desenvolvimento de Sistemas">Analise e Desenvolvimento de Sistemas</option>
                                                <option value="Gestão Empresarial">Gestao Empresarial</option>                                                
                                            </select>
                                            <p class="help-block">Escolha o curso da disciplina.</p>
                                        </div>
