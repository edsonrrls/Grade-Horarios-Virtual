...
$consulta2 = "SELECT * FROM disciplina";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">CADASTRO PROFESSOR - DISCIPLINA</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="processa_cad_prof_disc.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="disciplina" required="">
                                                ...
                                                <option value="<?php echo $dado["cod_disc"]; ?>">
                                                    <?php echo $dado["nome_disc"]; ?>
                                                </option>   
                                                <?php } ?>                                             
                                            </select>
                                            <p class="help-block">Escolha o nome da disciplina.</p>
                                        </div>
