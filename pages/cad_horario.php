...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">CADASTRO DE HORÁRIO</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="processa_cad_horario.php">
                                        <div class="form-group">
                                            <label>Hora de início da aula:</label>
                                            <input type="time" class="form-control" required="" name="hora_ini">
                                            <p class="help-block">Escolha ou digite a hora.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Hora de término da aula:</label>
                                            <input type="time" class="form-control" required="" name="hora_fim">
                                            <p class="help-block">Escolha ou digite a hora.</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">Escolha o período do dia da aula.</p>
                                        </div>
